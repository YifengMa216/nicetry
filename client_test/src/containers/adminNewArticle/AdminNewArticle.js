...
import { actions } from "../../reducers/admin/managerNewPage";
import { actions as tagActions } from "../../reducers/admin/managerTags";
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminNewArticle);
